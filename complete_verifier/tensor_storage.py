...
class TensorStorage(object):
    ...
    def __init__(self, full_shape, initial_size=1024, switching_size=65536, dtype=torch.float32, device='cpu',
                 concat_dim=0):
        """
    ...
    def append(self, appended_tensor):
        ...
        self._storage.narrow(self.concat_dim, self.num_used, appended_tensor.size(self.concat_dim)).copy_(
            appended_tensor)
